        ...
        <div class="container-fluid">
            ...
            <?php
                if(!$PersonalN==""){
                    ...
                    if(mysql_num_rows($selectPersonalByName)>=1){
                        echo '<ul id="itemContainer" class="list-unstyled">';
                        $c=1;
                        while($dataP=mysql_fetch_array($selectPersonalByName)){
                            echo '<li>
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                    ...
                    mysql_free_result($selectPersonalByName);
                }else{
                    $selectAllPersonal=ejecutarSQL::consultar("SELECT * FROM personal ORDER BY Apellido ASC, Nombre ASC");
                    if(mysql_num_rows($selectAllPersonal)>=1){
                        echo '<ul id="itemContainer" class="list-unstyled">';
                        $c=1;
                        while($data=mysql_fetch_array($selectAllPersonal)){
                            echo '<li>
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                    ...
                    mysql_free_result($selectAllPersonal);
                }
            ?>
        </div>
