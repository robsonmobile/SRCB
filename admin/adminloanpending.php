    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                if(mysql_num_rows($checkLoansPending)>=1){
                    ...
                    while($data=mysql_fetch_array($checkLoansPending)){
                        ...
                        if(mysql_num_rows($checkLoanU2)>=1){
                            $dataU2=mysql_fetch_array($checkLoanU2);
                            $selectStudentData=ejecutarSQL::consultar("SELECT * FROM estudiante WHERE NIE='".$dataU2['NIE']."'");
                            $dataS=mysql_fetch_array($selectStudentData);
                        ...
                        if(mysql_num_rows($checkLoanU3)>=1){
                            $dataU3=mysql_fetch_array($checkLoanU3);
                        ...
                        mysql_free_result($checkLoanU1);
                        mysql_free_result($checkLoanU2);
                        mysql_free_result($checkLoanU3);
                        mysql_free_result($checkLoanU4);
                        mysql_free_result($selectTeacherData);
                        mysql_free_result($selectStudentData);
                        mysql_free_result($selectPersonalData);
                        mysql_free_result($selecBook);
                    }
                ...
                mysql_free_result($checkLoansPending);
            ?>
        </div>
