    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                if(mysql_num_rows($checkingRservations)>=1){
                    ...
                    while($data=mysql_fetch_array($checkingRservations)){
                        $y++;
                        $checkReserU1=ejecutarSQL::consultar("SELECT * FROM prestamodocente WHERE CodigoPrestamo='".$data['CodigoPrestamo']."'");
                        if(mysql_num_rows($checkReserU1)>=1){
                            $dataU1=mysql_fetch_array($checkReserU1);
                        ...
                        if(mysql_num_rows($checkReserU2)>=1){
                            $dataU2=mysql_fetch_array($checkReserU2);
                        ...
                        if(mysql_num_rows($checkReserU3)>=1){
                            $dataU3=mysql_fetch_array($checkReserU3);
                        ...
                        mysql_free_result($checkReserU1);
                        mysql_free_result($checkReserU2);
                        mysql_free_result($checkReserU3);
                ...
                mysql_free_result($checkingRservations);
            ?>
        </div>
