...
<?php
    ...
    while ($conySt=mysql_fetch_array($checkResSt)){
        ...
        while($conySt2=mysql_fetch_array($checkResStP)){
            ...
            ';
            mysql_free_result($dataBooks);
        }
        mysql_free_result($checkResStP); 
    }
    mysql_free_result($checkResSt);
?>
</div>