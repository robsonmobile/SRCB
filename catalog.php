...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <?php
            ...
            if(mysql_num_rows($checkingAllBooks)>0){
                ...
                if($VarCategoryCatalog==''){
                    ...
                    if(mysql_num_rows($checkCodeBook)>0){
                            ...
                            mysql_free_result($selectCategC);
                            echo '<div class="container-fluid">
                                <ul id="itemContainer" class="list-unstyled">';
                                    $countBook=1;
                                    while ($bookCodeInfo=mysql_fetch_array($checkCodeBook)){
                                    echo '<li>
